...
import { validateToolResultOutput } from './parseToolResultOutput.js';
...
export function UserToolSuccessMessage({
  ...
  const validatedOutput = validateToolResultOutput(tool, message.toolUseResult);
  if (!validatedOutput.success) {
    return null;
  }
  const toolResult = validatedOutput.output;
